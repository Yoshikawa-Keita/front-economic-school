      ...
      <div className="university-nav p-5">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {universities.map((university) => (
                <li key={university} className="rounded shadow-lg hover:shadow-xl transition-shadow duration-200">
                    <Link href={`/university/${encodeURIComponent(university)}`} className="block p-4 text-center text-blue-600 hover:text-blue-800 transition-colors duration-200">
